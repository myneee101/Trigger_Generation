...
with open(output_labels_file, 'w') as output_f:
    for image_file in image_files:
        ...
        if image_file in image_files:
            ...
            # Modify the label
            # For demonstration purposes, let's assume we add a prefix 'modified_' to the original label
            modified_label = 'modified_' + labels[image_files.index(image_file)]

            # Write the modified label to the output labels file
            output_f.write(f'{image_file}: {modified_label}\n')
